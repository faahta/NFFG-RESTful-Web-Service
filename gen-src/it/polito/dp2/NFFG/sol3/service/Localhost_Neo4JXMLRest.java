...
}, comments = "wadl2java, http://wadl.java.net", date = "2017-01-14T15:02:36.175-08:00")
public class Localhost_Neo4JXMLRest {
    ...
    public static class Resource {
        ...
        public static class Node {
            ...
            public it.polito.dp2.NFFG.sol3.service.Node postXmlAsNode(it.polito.dp2.NFFG.sol3.service.Node input) {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(it.polito.dp2.NFFG.sol3.service.Node.class);
            }
        ...
        public static class NodeNodeid {
            ...
            public it.polito.dp2.NFFG.sol3.service.Node getAsNode() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
        ...
        public static class NodeNodeidRelationship {
            ...
            public it.polito.dp2.NFFG.sol3.service.Relationship postXmlAsRelationship(it.polito.dp2.NFFG.sol3.service.Relationship input) {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(it.polito.dp2.NFFG.sol3.service.Relationship.class);
            }
        ...
        public static class Nodes {
            ...
            public it.polito.dp2.NFFG.sol3.service.Nodes getAsNodes() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(it.polito.dp2.NFFG.sol3.service.Nodes.class);
            }
        ...
        public static class RelationshipRelationshipid {
            ...
            public it.polito.dp2.NFFG.sol3.service.Relationship getAsRelationship() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
